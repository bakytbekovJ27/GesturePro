...
const translations = {
  ru: {
    ...
    settings_delay: 'Задержка жестов',
    settings_delay_hint: 'Интервал ожидания между жестами смены слайдов (в секундах).',
    settings_seconds: 'сек',
    settings_delay_fast: 'Быстро',
    settings_delay_slow: 'Медленно',
    settings_drawing: 'Режим рисования',
    settings_drawing_hint: 'Включите, чтобы делать аннотации на слайдах. Рисунки сохраняются отдельно для каждого слайда.',
    settings_drawing_on: 'Включено',
    settings_drawing_off: 'Выключено',
  ...
  en: {
    ...
    settings_delay: 'Gesture trigger delay',
    settings_delay_hint: 'Adjust the cooldown time between consecutive slide gestures (in seconds).',
    settings_seconds: 's',
    settings_delay_fast: 'Fast',
    settings_delay_slow: 'Slow',
    settings_drawing: 'Drawing mode',
    settings_drawing_hint: 'Enable to annotate slides with freehand drawings. Annotations are saved per slide.',
    settings_drawing_on: 'Enabled',
    settings_drawing_off: 'Disabled',
