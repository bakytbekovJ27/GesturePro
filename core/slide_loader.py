...
def load_pdf(
    pdf_path: str, width: int = SLIDE_W, height: int = SLIDE_H, dpi: int = PDF_DPI
) -> list[np.ndarray]:
...
def load_folder(
    folder: str, width: int = SLIDE_W, height: int = SLIDE_H
) -> list[np.ndarray]:
...
def create_demo_slides(width: int = SLIDE_W, height: int = SLIDE_H) -> list[np.ndarray]:
